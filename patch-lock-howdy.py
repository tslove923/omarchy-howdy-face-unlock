...
PATCHES = [
    ...
    (
        ...
        '      if (root.lockRequested && root.howdyConfigured) howdyRetryTimer.restart()\n'
        '    }\n'
        '  }\n'
        '\n'
        '  Timer {\n'
    ...
    (
        ...
        '  Process {\n'
        '    id: howdyCheckProc\n'
        '    command: ["bash", "-c", "if [[ -f /etc/pam.d/omarchy-lock-howdy ]] && [[ -f \\"/etc/howdy/models/$USER.dat\\" ]]; then echo yes; else echo no; fi"]\n'
        ...
        '      else if (!root.howdyConfigured && howdyPam.active) howdyPam.abort()\n'
        '    }\n'
        '  }\n'
    ),
    (
